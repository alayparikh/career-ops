...
1. **Identify targets** via WebSearch:
   ...
   - Assigned recruiter
   - 2-3 peers on the team (people with similar role)
...
3. **Generate message** with 3-sentence framework:
   ...
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement relevant to THIS role (e.g., "I built an AI agent handling 90% of customer service at my company before selling it")
...
5. **Alternative targets** with justification why they are good second choices
